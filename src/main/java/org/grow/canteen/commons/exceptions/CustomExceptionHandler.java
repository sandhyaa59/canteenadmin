...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<ErrorResponse> restExceptionHandler(RestException restException){
        ErrorResponse errorResponse=new ErrorResponse(restException.getCode(),restException.getMessage());
...
//    }
    ...
    protected ResponseEntity<Object> handleExceptionInternal(Exception ex, Object body, HttpHeaders headers, HttpStatusCode statusCode, WebRequest request) {
        ErrorResponse errorResponse=new ErrorResponse(String.valueOf(statusCode.value()),
                ex.getMessage());
        return  new ResponseEntity<>(errorResponse, HttpStatus.INTERNAL_SERVER_ERROR);
    }
}
